...
const testimonialOne = [
  {
    name: "Piyush Lodha",
    title: "Trader, Raipur",
    header: "VR Wedding coverage is game changer!",
    description:
      "We were skeptical at first, but as soon as we put on the headset and watched our special day unfold before us, we were completely sold. The 360-degree video captured every moment and the post-production process brought the experience to life in a way we never thought possible. We would highly recommend this to any couple looking to preserve their memories in the most stunning and immersive way possible!",
  ...
  },
  {
    name: "Anuj & Sikha",
    title: "Couple, Nagpur",
    header: "It feels like I am attending my wedding again!",
    description:
      " Our VR wedding coverage was a truly magical experience. The level of immersion and detail was unlike anything we've ever seen before. It was like being transported back in time to relive our special day over and over again. We are so grateful for this incredible technology and would recommend it to anyone looking to preserve their memories in a unique and unforgettable way!",
  ...
  },
  {
    ...
    header: "Innovation helped me impress client and happy",
    description:
      " As a photographer, I was blown away by the experience of covering a VR wedding. The ability to capture every moment from every angle was truly phenomenal and allowed me to create memories that will last a lifetime for the bride and groom. The post-production process was seamless and the final product was nothing short of amazing. I highly recommend this to any photographer looking to elevate their craft and offer their clients something truly special.",
    image: "/testimonial/t-3.jpg",
    target: "testimonial-tab-3",
  },
  {
    name: "Tanya Jha",
    title: "Lawyer Bride, Mumbai ",
    header: "Simply Wow Experience! Speechless.",
    description:
      "VR wedding coverage was beyond our wildest dreams! From the moment we put on the headset, we were transported back to our special day and felt like we were truly reliving every single moment. The 360-degree video captured every detail and we were blown away by the quality. We highly recommend this experience to every bride and groom looking to preserve their memories forever!",
    image: "/testimonial/t-4.jpg",
    target: "testimonial-tab-4",
  },
  {
    name: "Nilanjay",
    title: "Wedding Photographer, Pune",
    header: "VR Wedding is the future of wedding coverage",
    description:
      " VR Wedding is extraordinary innovation. The 360-degree video allowed me to capture moments I would have never been able to with traditional photography techniques. The bride and groom were overjoyed with the final product and I was proud to have been a part of such a unique and exciting experience. I highly recommend this to any photographer looking to take their work to the next level",
